...
AVANCES_POR_BOMBERO = 1  # el fuego avanza al cerrar el turno de cada bombero
ESTRATEGIA = "mejorada"
RESCATISTAS = 2          # el reparto que mas partidas gana, medido en analisis/
TABLERO = os.path.join(carpeta, "..", "tableros", "tablero_final.txt")


def nueva_partida():
    return FlashPointModel(ESTRATEGIA, AVANCES_POR_BOMBERO, 7, 4, 24, RESCATISTAS, TABLERO)
